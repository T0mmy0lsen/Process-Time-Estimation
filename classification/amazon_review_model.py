...
train_df = Loader.load_amazon_reviews()
print(train_df.shape)

test_df = Loader.load_amazon_reviews()
print(test_df.shape)

dataset = train_df.sample(n=10000, random_state=42)
...
holdout = train_df.sample(n=10000, random_state=43)
holdout_corpus = holdout['review'].values
holdout_target = holdout['sentiment'].values
...
checkpointer = ModelCheckpoint(filepath=train_params.model_file_path, verbose=1, save_best_only=True, save_weights_only=True)
