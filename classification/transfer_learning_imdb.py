...
amazon_review_model = DocumentModel.load_model('model/amazonreviews/model_06.json')
amazon_review_model.load_model_weights('model/amazonreviews/model_06.hdf5')
